...
public:
    ...
    // Frame-rate preset: 0 = follow the monitor refresh rate, -1 = uncapped,
    // positive (30/60/90/120/144/180/...) = fixed FPS ceiling. Gameplay logic
    // is independent of the frame rate (ADR-0001), so this is a pure
    // presentation setting.
    int GetFpsPreset() const { return m_fpsPreset; }
    void SetFpsPreset(int preset);
